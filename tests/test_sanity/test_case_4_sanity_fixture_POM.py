...
path_json_credential = (
    Path(__file__).resolve().parent.parent.parent / "TestData" / "credentials.json"
)
...
@pytest.mark.parametrize(
    "user_credentials_valid", credentials_data["valid_user_credentials"]
)
